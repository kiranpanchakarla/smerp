														...
														<table id="example" class="display nowrap table table_padding_custom table-hover table-striped table-bordered"
															...
															<c:forEach items="${companyList}" var="companyList">
																...
																<td><c:set var="count" value="${count + 1}" scope="page" />
															    	...
															    	<a  class ="btn btn-view" href="<c:url value="/company/view?companyId=${companyList.id}"/>"><i class="icon-eye3 left" data-toggle="tooltip" data-placement="right" title="View"></i></a>
																	 </c:if> 
									       								</c:if>     
   															    	 </c:forEach>
																	</td>
