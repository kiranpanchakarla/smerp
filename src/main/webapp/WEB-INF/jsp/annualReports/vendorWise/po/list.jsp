								...
								<div class="content-body">
									...
									<div class="card">
										<div class="card-header" style="height: 60px;">
											<div class="row">
												<div class="col-md-8">
													<h2 class="content-header-title">Purchase Order - Vendor Wise Annual Report</h2>
												</div>
...
function getSearchFilterList() {
	...
	var formdatepicker = $('#fromDate1').val();
	var todatepicker = $('#toDate1').val(); 
	$('#searchFilterForm').attr('action',"<c:url value='/annualVendorReport/getSearchFilterPOList'/>").submit();
...
function getSearchFilterResetList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/annualVendorReport/polist'/>").submit();
} 
...
function downloadExcelFile(){		
	...
	//alert(stringQuery);
	a.href = "<c:url value='/annualVendorReport/exportPOExcel?id=vw_vendor_wise_po_report?'/>"+stringQuery;
}
