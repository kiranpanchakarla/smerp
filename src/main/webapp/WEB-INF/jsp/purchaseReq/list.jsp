...
<body data-open="click" data-menu="vertical-menu" data-col="2-columns"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                      <c:choose>
                                                                       ...
                                                                       <c:when  test="${ purchaseRequestsList.status == 'Partially_Approved' }"> 
                                                                      <c:forEach items="${sessionScope.umpmap}" var="ump">
                                                                    ...
                                                                    <c:when test="${fn:containsIgnoreCase(permissions,'Multilevel Approval')}">  <a class="btn btn-delete" href="#"
                                                                      ...
                                                                      <c:when  test="${purchaseRequestsList.status != 'Approved' && purchaseRequestsList.status != 'Partially_Approved' && purchaseRequestsList.status!='ConvertedToRFQ'   && purchaseRequestsList.status != 'Rejected' }">
    ...
    function getSearchFilterList() {
		...
		$('#searchFilterForm').attr('action',"<c:url value='/purchaseReq/getSearchFilterList'/>").submit();
	} 
 	...
 	function downloadExcelFile(){		
		...
		a.href = "<c:url value='/purchaseReq/exportPRExcel?'/>"+stringQuery;
	} 
