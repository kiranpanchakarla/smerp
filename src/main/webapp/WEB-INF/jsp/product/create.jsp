...
<link href="<c:url value="/resources/components/bootstrap-validator/js/jquery.min.js"/>"
    rel="stylesheet" type="text/css" />
    
  <link href="<c:url value="/resources/components/bootstrap-validator/js/bootstrap.min.js"/>"
    rel="stylesheet" type="text/css" />  
    
     <link href="<c:url value="/resources/components/bootstrap-validator/js/validator.min.js"/>"
    rel="stylesheet" type="text/css" />  
