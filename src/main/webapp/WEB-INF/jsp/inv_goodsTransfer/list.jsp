...
<body data-open="click" data-menu="vertical-menu" data-col="2-columns"
								...
								<div class="content-body">
									...
									<div class="card">
										<div class="card-header" style="height: 60px;">
											<div class="row">
												<div class="col-md-4">
													<h2 class="content-header-title">Inventory Goods Transfer</h2>
												</div>
												<div class="col-md-4">
														...
														<c:if test="${ump.key eq 'Inventory Goods Transfer'}">
															...
															<c:if
																...
																<a class="btn btn-primary"
																	href="<c:url value="/invgt/create"/>">Create</a>
															</c:if>
														</c:if>
													</c:forEach>
												...
												<div class="col-md-4">
													<ol class="breadcrumb">
														...
														<li class="breadcrumb-item active">Inventory Goods Transfer</li>
													</ol>
												</div>
											</div>
																		...
																		<c:when  test="${ list.status == 'Partially_Approved' }"> 
	                                                                      <c:forEach items="${sessionScope.umpmap}" var="ump">
	                                                                        ...
	                                                                        <c:when test="${fn:containsIgnoreCase(permissions,'Multilevel Approval')}">  <a class="btn btn-edit"
	                                                                                href="<c:url value="/invgt/edit?id=${list.id}"/>" data-toggle="tooltip" data-placement="top" title="Edit"><i
																			...
																			<c:if test="${ump.key eq 'Inventory Goods Transfer'}">
																				...
																				<c:if
																					...
																					<a class="btn btn-view"
																						href="<c:url value="/invgt/view?id=${list.id}"/>" data-toggle="tooltip" data-placement="top" title="View"><i
	...
	function getSearchFilterList() {
		...
		$('#searchFilterForm').attr('action', "<c:url value='/invgt/getSearchFilterList'/>").submit();
	} 
 	...
 	function downloadExcelFile(){		
		...
		a.href = "/invgt/exportINVGTExcel?'/>"+stringQuery;
	}
