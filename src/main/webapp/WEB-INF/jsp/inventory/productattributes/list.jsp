								...
								<div class="content-body">
									...
									<div class="card">
										<div class="card-header" style="height: 60px;">
											<div class="row">
												<div class="col-md-3">
													<h4 class="content-header-title">Product Attributes</h4>
												</div>
												<div class="col-md-5">
												...
												<c:if test="${ump.key eq 'Admin Master'}">
														...
														href="<c:url value="/productattributes/create"/>">Create</a>
													    </c:if>
												</c:if>
												</c:forEach>
												</div>
											...
											<div class="card-block card-dashboard">
												...
												<div class="">
													<table id="example"
														...
														<tbody>
															<c:forEach items="${productattributesList}" var="productattributes">
																<tr>
																	<td><c:set var="count"
												...
												<c:set var="permissions" scope="session" value="${ump.value}" />
														<c:if test="${fn:containsIgnoreCase(permissions,'update')}">
																	<a
																		class="btn btn-edit"
																		href="<c:url value="/productattributes/getInfo?productattributesId=${productattributes.id}"/>" data-toggle="tooltip" data-placement="right" title="Edit">
														...
														<c:if test="${fn:containsIgnoreCase(permissions,'delete')}">
																	  <a class="btn btn-delete mr-1" href="#"
																		onclick="deleteById('<c:out value="${productattributes.id}"/>','/productattributes/delete')" data-toggle="tooltip" data-placement="right" title="Delete"><i
														...
														<c:if test="${fn:containsIgnoreCase(permissions,'view')}">				
																			<a
																		class="btn btn-view"
																		href="<c:url value="/productattributes/view?productattributesId=${productattributes.id}"/>" data-toggle="tooltip" data-placement="right" title="View"><i
