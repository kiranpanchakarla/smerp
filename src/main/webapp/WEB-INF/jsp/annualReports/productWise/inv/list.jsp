...
<body data-open="click" data-menu="vertical-menu" data-col="2-columns"
								...
								<div class="content-body">
									...
									<div class="card">
										<div class="card-header" style="height: 60px;">
											<div class="row">
												<div class="col-md-5">
													<h2 class="content-header-title">Invoice - Product
														Wise Annual Report</h2>
												</div>
	...
	<script type="text/javascript">
		...
		function getSearchFilterList() {
			...
			$('#searchFilterForm').attr('action',
					"<c:url value='/annualProductReport/getSearchFilterINVList'/>")
					.submit();
		}
		...
		function getSearchFilterResetList() {
			...
			$('#searchFilterForm').attr('action',
					"<c:url value='/annualProductReport/invlist'/>").submit();
		}
		...
		function downloadExcelFile() {
			...
			a.href = "<c:url value='/annualProductReport/exportPOExcel?id=vw_product_wise_inv_report?'/>"
					+ stringQuery;
		}
	</script>
	<script
