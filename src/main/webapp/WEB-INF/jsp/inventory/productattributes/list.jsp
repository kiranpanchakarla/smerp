														...
														<tbody>
															<c:forEach items="${productattributesList}" var="productattributes">
																<tr>
																	...
																	<td><a
																		class="btn btn-edit"
																		href="<c:url value="/productattributes/getInfo?productattributesId=${productattributes.id}"/>">
																			<i class="icon-edit left"></i>
																	</a>  <a class="btn btn-delete mr-1" href="#"
																		onclick="deleteById('<c:out value="${productattributes.id}"/>','/productattributes/delete')"><i
																			class="icon-bin left"></i></a>  <a
																		class="btn btn-view"
																		href="<c:url value="/productattributes/view?productattributesId=${productattributes.id}"/>"><i
