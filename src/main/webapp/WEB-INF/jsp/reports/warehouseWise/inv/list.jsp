								...
								<div class="content-body">
									...
									<div class="card">
										<div class="card-header" style="height: 60px;">
											<div class="row">
												<div class="col-md-5">
													<h2 class="content-header-title">Invoice - Warehouse Wise Report</h2>
												</div>
												<div class="col-md-3">
...
function getSearchFilterList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/warehouseReport/getSearchFilterINVList'/>").submit();
} 


function getSearchFilterResetList() {
	 
	$('#searchFilterForm').attr('action',"<c:url value='/warehouseReport/invlist'/>").submit();
} 
...
function downloadExcelFile(){		
	...
	a.href = "<c:url value='/warehouseReport/exportPOExcel?id=vw_plant_wise_inv_report?'/>"+stringQuery;
} 
</script>
