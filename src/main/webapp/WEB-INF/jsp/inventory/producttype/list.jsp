											...
											<div class="card-block card-dashboard">
												...
												<c:set var="permissions" scope="session" value="${ump.value}" />
														<c:if test="${fn:containsIgnoreCase(permissions,'update')}">
																	<a
																		class="btn btn-edit"
																		href="<c:url value="/producttype/getInfo?producttypeId=${producttype.id}"/>" data-toggle="tooltip" data-placement="right" title="Edit">
														...
														<c:if test="${fn:containsIgnoreCase(permissions,'delete')}">
																	 <a class="btn btn-delete mr-1" href="#"
																		onclick="deleteById('<c:out value="${producttype.id}"/>','/producttype/delete')" data-toggle="tooltip" data-placement="right" title="Delete"><i
														...
														<c:if test="${fn:containsIgnoreCase(permissions,'view')}">				
																			 <a
																		class="btn btn-view"
																		href="<c:url value="/producttype/view?producttypeId=${producttype.id}"/>" data-toggle="tooltip" data-placement="right" title="View"><i
