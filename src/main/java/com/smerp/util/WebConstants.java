...
public class WebConstants {
	...
	public final static String Offline_Gstr1_Summary = "offlineGstr1Summary.ftl";
	
	public final static String Offline_Purchase_Request = "purchaseRequestPdfFile.ftl";
