                ...
                <div class="row">
                    <div class="large-12 columns">
                        <div class="content-body">
                            ...
                            <form:form method="POST"  action="${createUrl}" class="commentForm" modelAttribute="uomObj" data-toggle="validator" role="form">
                                <section id="basic-form-layouts">
                                    <div class="row match-height">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h2 class="card-title" id="basic-layout-icons">UOM</h2>
                                                </div>
                                                            ...
                                                            <div class="form-body">
                                                                <div class="row">
                                                                    <div class="col-sm-4 form-group has-feedback">
                                                                        <label>UOM</label>: ${uomObj.uomName}

                                                                    </div>
                                                                    
                                                                    <div class="col-sm-4 form-group has-feedback">
                                                                        <label>Category</label>:  ${uomObj.uomCategory.uomCategoryName}
                                                                    </div>
