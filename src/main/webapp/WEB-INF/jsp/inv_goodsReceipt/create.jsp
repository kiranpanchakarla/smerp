				...
				<div class="row">
					<div class="large-12 columns">
						<div class="content-body">
							...
							<c:url value="/invgr/save" var="createUrl" />
													...
													<div class="col-md-6">
														...
														<c:if test="${gr.id==null}">
															<h2 class="card-title" id="basic-layout-icons">Create
																Inventory New Goods Receipt</h2>
														</c:if>
													</div>
													<div class="col-md-6">
														<c:if test="${gr.id!=null}">
																												...
																												var="listLineItems">
																													...
																													<tr class="multTot multTot${count}">
																														<td style="display: none;"><div
																																...
																																path="inventoryGoodsReceiptList[${count}].id" />
																														</td>
 
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="inventoryGoodsReceiptList[${count}].productNumber"
																																		required="true"
																															...
																															<td>
																																<div class="form-group">
																																	<form:input type="text"
																																		path="inventoryGoodsReceiptList[${count}].description"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="inventoryGoodsReceiptList[${count}].uom"
																															...
																															name="inventoryGoodsReceiptList[${count}].taxCode" style="width: 100%;">
																													...
																													<option value="${taxCodeMap.value}">${taxCodeMap.key}</option>
																														...
																														<input type="hidden" name="inventoryGoodsReceiptList[${count}].taxDescription"  class="taxDescription"  value="${listLineItems.taxDescription}"  />
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="inventoryGoodsReceiptList[${count}].taxTotal"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="inventoryGoodsReceiptList[${count}].total"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="inventoryGoodsReceiptList[${count}].productGroup"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="inventoryGoodsReceiptList[${count}].hsn"
																															...
																															<td><%-- <div class="form-group">
																																	<form:select class="form-control"
																																		style="width:;" required="true"
																																		path="inventoryGoodsReceiptList[${count}].warehouse">
																																		<form:option value="" label="Select" />
																																		<form:options items="${plantMap}" />
																																	</form:select>
																																</div> --%>
																																<div class="form-group"><select class="form-control warehouse" 
																															name="inventoryGoodsReceiptList[${count}].warehouse" style="width:100%;" id="toWarehouse${count}">
																														<c:forEach var="planMap" items="${plantMap}">
																													  	...
																													  	<c:choose>
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="inventoryGoodsReceiptList[${count}].requiredQuantity"
...
function addItem() {
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="inventoryGoodsReceiptList['+inc+'].productNumber" autocomplete="off"  class="form-control productNumber productNumber'+inc+'" required="true" id="productNumber'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td style="display:none;">'
			+'<div class="form-group">'
			+'<input type="hidden" name="inventoryGoodsReceiptList['+inc+'].productId" class="form-control productId productId'+inc+'" id="productId'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="inventoryGoodsReceiptList['+inc+'].description" required="true" autocomplete="off"  class="form-control description '+inc+'" id="description'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="inventoryGoodsReceiptList['+inc+'].uom" class="form-control uom uom'+inc+'" id="uom'+inc+'"  readonly="true"  />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="inventoryGoodsReceiptList['+inc+'].sku" class="form-control sku sku'+inc+'" id="uom'+inc+'"  readonly="true"  />'
			+ '</div>'
			+'</td>'
			...
			+ '<td>'
			+'<div class="form-group">'
			+ '<select  name="inventoryGoodsReceiptList['+inc+'].taxCode" required="true"   class="form-control taxCode" style="width: 100%;" id="taxCode'+inc+'" >'
			+'<option value="">Select</option>'+
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="inventoryGoodsReceiptList['+inc+'].taxTotal" onkeypress="return isNumericKey(event)"  readonly="true" class="form-control  taxTotal'+inc+' taxTotal" id="taxTotal'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="inventoryGoodsReceiptList['+inc+'].total" onkeypress="return isNumericKey(event)"  readonly="true" class="form-control total'+inc+' total" id="total'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="inventoryGoodsReceiptList['+inc+'].productGroup" readonly="true" class="form-control  productGroup productGroup'+inc+'" id="productGroup'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="inventoryGoodsReceiptList['+inc+'].hsn" readonly="true" class="form-control hsnVal hsn'+inc+'" id="hsn'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+ '<td>'
			+'<div class="form-group">'
			+ '<select  name="inventoryGoodsReceiptList['+inc+'].warehouse" required="true"  style="width: 100%;"  class="form-control warehouse'+inc+' warehouse"  id="toWarehouse'+inc+'" >'
			/* + scriptSelectPlant +
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="inventoryGoodsReceiptList['+inc+'].requiredQuantity" autocomplete="off" maxlength="5" onkeypress="return isNumericKey(event)"  required="true" class="form-control validatePrice requiredQuantity'+inc+' requiredQuantity" id="requiredQuantity'+inc+'"   />'
			+ '</div>'
			+'</td>'
