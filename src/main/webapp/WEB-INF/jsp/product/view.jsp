                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h2 class="card-title" id="basic-layout-icons">Product/View</h2>
                                                </div>
                                                <form:hidden path="id" />
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form">
                                                            <div class="form-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6 form-group has-feedback">
                                                                        <label>Product Group</label>: ${product.productCategory.name}
                                                                    </div>
                                                                    <div class="col-sm-6 form-group has-feedback">
                                                                        <label>UOM Group</label>: ${product.uomCategory.uomCategoryName}
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-12 form-group">
                                                                        <div class="inventory-list">
                                                                            <form:checkbox onclick="return false;" path="inventoryProduct" id="inventoryProduct" class="purchaseType" value="inventoryProduct" required="true" /> <span class="radio-list">Inventory Product</span>
                                                                            <!-- <div  class="help-block with-errors"></div> -->
                                                                        </div>

                                                                        <div class="inventory-list">
                                                                            <form:checkbox onclick="return false;" path="purchaseProduct" id="purchaseProduct" class="purchaseType" value="purchaseProduct" required="true" /> <span class="radio-list">Purchase Product</span>
                                                                            <!-- <div  class="help-block with-errors"></div> -->
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="tab-content">
                                                                    <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                                        <div class="row">
                                                                            <div class="col-sm-6 form-group has-feedback">
                                                                                <form:checkbox path="withOldTaxLiable" onclick="return false;" value="withOldTaxLiable" required="true" /><span class="radio-list">Withholding Tax Liable</span>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-6 form-group">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <div class="inventory-list">
                                                                                        <form:radiobutton class="product-category" onclick="return false;" name="productcategory" path="serviceOrProduct" required="true" value="service" /><span class="radio-list">Service</span></div>
                                                                                    <div class="inventory-list">
                                                                                        <form:radiobutton class="product-category" onclick="return false;" name="productcategory" path="serviceOrProduct" required="true" value="product" /><span class="radio-list">Product</span></div>
                                                                                    <!-- <div  class="help-block with-errors"></div> -->
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-sm-6 form-group">
                                                                                <div class="inventory-list">
                                                                                    <form:checkbox path="gst" value="gst" id="gstcategory" required="true" /><span class="radio-list">GST</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                       <c:if test="${product.serviceOrProduct eq 'service'}">
                                                                        ...
                                                                        <c:if test="${product.serviceOrProduct eq 'product'}">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4 form-group has-feedback">
                                                                                    <label>TaxCategory</label>: ${product.productTaxCategory}
                                                                                </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-6 form-group has-feedback">
                                                                                <label>Manage ProductBy</label>: ${product.manageProductBy}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="tab-pane " id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-4 form-group has-feedback">
                                                                                <label>Preferred Vendor</label>: ${product.preferredVendor}
                                                                            </div>
                                                                            <div class="col-sm-4 form-group has-feedback">
                                                                                <label>Purchasing UOM Name:</label>: ${product.purchasingUom.id}
                                                                            </div>
                                                                            <div class="col-sm-4 form-group has-feedback">
                                                                                <label>Products Per Purchase Unit</label>: ${product.produtPerPurchaseUnit}
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-sm-4 form-group has-feedback">
                                                                                <label>Packing UOM Name</label>: ${product.packingUom.id}
                                                                            </div>
                                                                            <div class="col-sm-4 form-group has-feedback">
                                                                                <label>Quantity Per Package</label>: ${product.qualityPerPackage}
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="tab-pane" id="messages" role="tabpanel" aria-labelledby="messages-tab">
                                                                        <div class="row">
                                                                            <div class="col-sm-4 form-group has-feedback">
                                                                                <label>Quantity Per Package</label>: ${product.inventoryUom.id}
                                                                            </div>
                                                                            <div class="col-sm-4 form-group has-feedback">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-4 form-group has-feedback">
                                                                                <label>Valuation Method</label>: ${product.valuationMethod}
                                                                            </div>
                                                                            <div class="col-sm-4 form-group has-feedback">
