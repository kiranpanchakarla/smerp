											...
											<div class="row">
												...
												<div class="col-md-4">
													<ol class="breadcrumb">
														...
														<li class="breadcrumb-item active">UOM Category</li>
													</ol>
												</div>
											</div>
														...
														<tbody>
															<c:forEach items="${uomcategoryList}" var="uomcategory">
																<tr>
																	...
																	<td><a
																		class="btn btn-edit"
																		href="<c:url value="/uomcategory/getInfo?uomcategoryId=${uomcategory.id}"/>">
																			<i class="icon-edit left"></i>
																	</a>  <a class="btn btn-delete mr-1" href="#"
																		onclick="deleteById('<c:out value="${uomcategory.id}"/>','/uomcategory/delete')"><i
																			class="icon-bin left"></i></a>  <a
																		class="btn btn-view"
																		href="<c:url value="/uomcategory/view?uomcategoryId=${uomcategory.id}"/>"><i
