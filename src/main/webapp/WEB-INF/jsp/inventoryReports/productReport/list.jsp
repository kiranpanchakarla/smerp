...
function getSearchFilterList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/invReport/getSearchFilterPROList'/>").submit();
} 


function getSearchFilterResetList() {
	 
	$('#searchFilterForm').attr('action',"<c:url value='/invReport/prolist'/>").submit();
} 
...
function downloadExcelFile(){		
	...
	//alert(stringQuery);
	a.href = "<c:url value='/invReport/exportPROExcel?id=vw_inv_stock_qty_report?'/>"+stringQuery;
} 
</script>
