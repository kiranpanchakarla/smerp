										...
										<div class="col-md-12" >
											<div class="card">
												<div class="card-header">
													<c:if test="${states.id==null}">
														<h2 class="card-title" id="basic-layout-icons">Create New States</h2>
													</c:if>

													<c:if test="${states.id!=null}">
														<h2 class="card-title" id="basic-layout-icons">Update State Details</h2>
													</c:if>
												</div>
