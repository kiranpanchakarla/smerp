...
function getSearchFilterList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/vendorReport/getSearchFilterPOList'/>").submit();
...
function getSearchFilterResetList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/vendorReport/polist'/>").submit();
} 
...
function downloadExcelFile(){		
	...
	a.href = "<c:url value='/vendorReport/exportPOExcel?id=vw_vendor_wise_po_report?'/>"+stringQuery;
	 </c:if>
} 
</script>
