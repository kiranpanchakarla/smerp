            ...
            <td height="220" align="center" valign="middle" bgcolor="#FFFFFF" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
               ...
               <!--  <p style="text-align: left;font-family: inherit;">Dear <b>Admin,</b> </p> -->
                ...
                <h2 style="font-size: 1.4rem;color: #106570;font-weight: 600;margin: 10px 0; border-bottom: 1px solid rgba(0, 0, 0, 0.1); padding-bottom: 10px;font-family: inherit;">Inventory Status</h2>
                ...
                <td style="border: solid 1px ;"><#if productlist.plantName??> &nbsp;${productlist.plantName}</#if></td>
                <td style="border: solid 1px ;"><#if productlist.productDescription??>&nbsp;${productlist.productDescription}</#if></td>
                <td style="border: solid 1px ;"><#if productlist.productGroupDescription??>&nbsp;${productlist.productGroupDescription}</#if></td>
                <td style="border: solid 1px ;"><#if productlist.uomName??>&nbsp;${productlist.uomName}</#if></td>
                <td style="border: solid 1px ;"><#if productlist.instockQty??>&nbsp;${productlist.instockQty}</#if></td>
                </tr>
                </#list>
                </table>
               </#if>
