	...
	<script type="text/javascript">
		...
		function getSearchFilterList() {
			...
			$('#searchFilterForm').attr('action',
					"<c:url value='/productReport/getSearchFilterINVList'/>")
					.submit();
		}
		...
		function getSearchFilterResetList() {
			...
			$('#searchFilterForm').attr('action',
					"<c:url value='/productReport/invlist'/>").submit();
		}
		...
		function downloadExcelFile() {
			...
			a.href = "<c:url value='/productReport/exportPOExcel?id=vw_product_wise_inv_report?'/>"
					+ stringQuery;
		}
	</script>
	<script
