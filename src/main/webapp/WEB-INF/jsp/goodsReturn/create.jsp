																												...
																												<c:if test="${gre.grId!=null}"> 
																													...
																													<tr class="multTot multTot${count}">
																														<td style="display: none;"><div
																																...
																																path="goodsReturnLineItems[${count}].id" />
																														...
																														<c:if test="${gre.category=='Item'}">
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="goodsReturnLineItems[${count}].prodouctNumber"
																																		readonly="true"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="goodsReturnLineItems[${count}].uom"
																													...
																													<c:otherwise>
																															...
																															<td class="gr-main"><img
																																...
																																<c:choose>
																																	<c:when
																																		...
																																		<div class="form-group">
																																			<form:input type="text"
																																				path="goodsReturnLineItems[${count}].requiredQuantity"
																														...
																														<c:if test="${gre.category!='Item'}">
																															...
																															<td>
																																<div class="form-group">
																																	<form:input type="text" readonly="true"
																																		path="goodsReturnLineItems[${count}].sacCode"
																																		onkeypress="return isNumericKey(event)"
...
function addItem() {
	  ...
	  if ($('#items_radio').is(":checked") == true) {
		  //alert("itemAppend");
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].prodouctNumber" autocomplete="off"  class="form-control prodouctNumber prodouctNumber'+inc+'" required="true" id="prodouctNumber'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td style="display:none;">'
			+'<div class="form-group">'
			+'<input type="hidden" name="goodsReturnLineItems['+inc+'].productId" class="form-control productId productId'+inc+'" id="productId'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].uom" class="form-control uom uom'+inc+'" id="uom'+inc+'"  readonly="true"  />'
			+ '</div>'
			+'</td>'
			...
			+ '<td>'
			+'<div class="form-group">'
			+ '<select  name="goodsReturnLineItems['+inc+'].taxCode" required="true"   class="form-control  taxCode" style="width: 100%;"  id="taxCode'+inc+'" >'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].taxTotal" onkeypress="return isNumericKey(event)"  readonly="true" class="form-control  taxTotal'+inc+' taxTotal" id="taxTotal'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].total" onkeypress="return isNumericKey(event)"  readonly="true" class="form-control total'+inc+' total" id="total'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].productGroup" readonly="true" class="form-control  productGroup productGroup'+inc+'" id="productGroup'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].hsn" readonly="true" class="form-control hsnVal hsn'+inc+'" id="hsn'+inc+'"   />'
			+ '</div>'
			+'</td>'
	...
	+'</tr>';
		...
		// alert("sERVICEAppend");
		  var service_table_data='<tr class="multTot multTot'+inc+'">'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].sacCode" autocomplete="off" required="true"  class="form-control sacCode  sacCode'+inc+'" id="hsn'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].description" readonly="true" class="form-control description '+inc+'" id="uom'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].requiredQuantity" autocomplete="off" required="true" onkeypress="return isNumericKey(event)"  class="form-control validatePrice requiredQuantity'+inc+' requiredQuantity" id="requiredQuantity'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="goodsReturnLineItems['+inc+'].unitPrice" autocomplete="off"  onkeypress="return isNumericKey(event)"  required="true" class="form-control validatePrice unitPrice  unitPrice'+inc+'" id="unitPrice'+inc+'"   />'
			+ '</div>'
			+'</td>'
...
$("#items_radio").click(function() {
	//alert("item");
	 alertify.confirm("Goods Return",'Are you Sure Want to Change  Item ,Service will be removed ', function(){
		 $("#serviceTbl").hide();
		 $("#itemTbl").show();
...
$("#service_radio").click(function() {
	//alert("service");
	 alertify.confirm("Goods Return",'Are you Sure Want to Change Service ,Items will be removed! ', function(){
	$("#serviceTbl").show();
	 $("#itemTbl").hide();
	 $("#edit_item_serviceTbl").hide();
...
//$('form.commentForm').on('submit', function(event) {
  $(".mySubButton").on('click', function() {
	...
	if(rowCount == 0){
		alertify.alert("Goods Return","Please Select Atleast One Item");
		 return false;
	}else{
		return true;
	}
    ...
    if ($('#service_radio').is(":checked") == true) {
 	...
 	if(rowCount1 == 0){
 		alertify.alert("Goods Return","Please Select Atleast One  Service");
 		 return false;
 	}else{
 		return true;
 	}
...
$(document).on("keyup", ".requiredQuantity", function() {
	...
	if(totalAmt!="") {
	 ...
	 $("#amtRounding").val(totalPayment);
		 ...
		 $("#totalDiscount").val("");
		alertify.alert("Goods Return Discount","Please Enter Valid Discount!");
		 return false;
	}
