										...
										<div class="col-md-12">
											<div class="card-box">
												...
												<div class="col-md-6">
													...
													<div class="col-md-6">
														<c:if test="${cre.id!=null}">
														 	<a  class="btn btn-primary float-right"> ${cre.status} </a>
														</c:if>
													</div>
													<c:if test="${cre.id==null}">
																...
																<div class="card-body collapse in">
																												...
																												<c:if test="${cre.invId!=null}"> 
																													...
																													<tr class="multTot multTot${count}">
																														<td style="display: none;"><div
																																...
																																path="creditMemoLineItems[${count}].id" />
																														...
																														<c:if test="${cre.category=='Item'}">
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="creditMemoLineItems[${count}].prodouctNumber"
																																		readonly="true"
																															...
																															<td>
																																<div class="form-group">
																																	<form:input type="text"  
																																		path="creditMemoLineItems[${count}].description"
																																		readonly="true"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="creditMemoLineItems[${count}].uom"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="creditMemoLineItems[${count}].sku"
																															...
																															<td><div class="form-group">
																																	<form:input type="text" readonly="true"
																																		path="creditMemoLineItems[${count}].unitPrice"
																															...
																															<td><div class="form-group">
																																...
																																<input type="hidden" name="creditMemoLineItems[${count}].taxDescription"  class="taxDescription"  value="${listLineItems.taxDescription}"   />
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="creditMemoLineItems[${count}].taxTotal"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="creditMemoLineItems[${count}].total"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="creditMemoLineItems[${count}].productGroup"
																															...
																															<td><div class="form-group">
																																	<form:input type="text"
																																		path="creditMemoLineItems[${count}].hsn"
																													...
																													<c:otherwise>
																															...
																															<td class="gr-main"><img
																																...
																																<c:choose>
																																	<c:when
																																		...
																																		<div class="form-group">
																																			<form:input type="text"
																																				path="creditMemoLineItems[${count}].requiredQuantity"
																														...
																														<c:if test="${cre.category!='Item'}">
																															...
																															<td>
																																<div class="form-group">
																																	<form:input type="text" readonly="true"
																																		path="creditMemoLineItems[${count}].sacCode"
																																		onkeypress="return isNumericKey(event)"
																	...
																	<form:textarea type="text" cssClass="form-control camelCase"
																		...
																		<div class="text-xs-center">
																			...
																			<c:if test="${cre.status eq 'Draft' || cre.id==null }">
																			...
																			<c:if test="${cre.id!=null}">
																				...
																				<%--  <a href="<c:url value="/gr/cancelStage?id=${cre.id}"/>">
																			...
																			<c:forEach items="${sessionScope.umpmap}" var="ump">
																				<c:if test="${ump.key eq 'Credit Memo'}">
																					...
																					<c:if
																						...
																						<c:if test="${cre.status != 'Cancelled'}">
...
function addItem() {
	  ...
	  if ($('#items_radio').is(":checked") == true) {
		  //alert("itemAppend");
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].prodouctNumber" autocomplete="off"  class="form-control prodouctNumber prodouctNumber'+inc+'" required="true" id="prodouctNumber'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td style="display:none;">'
			+'<div class="form-group">'
			+'<input type="hidden" name="creditMemoLineItems['+inc+'].productId" class="form-control productId productId'+inc+'" id="productId'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].description" readonly="true" class="form-control description '+inc+'" id="description'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].uom" class="form-control uom uom'+inc+'" id="uom'+inc+'"  readonly="true"  />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].sku" class="form-control sku sku'+inc+'" id="sku'+inc+'"  readonly="true"  />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].requiredQuantity" autocomplete="off" onkeypress="return isNumericKey(event)" maxlength="5"  required="true" class="form-control validatePrice requiredQuantity'+inc+' requiredQuantity" id="requiredQuantity'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].unitPrice" autocomplete="off" onkeypress="return isNumericKey(event)"  readonly="true" required="true" class="form-control validatePrice unitPrice'+inc+' unitPrice" id="unitPrice'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].taxTotal" onkeypress="return isNumericKey(event)"  readonly="true" class="form-control  taxTotal'+inc+' taxTotal" id="taxTotal'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].total" onkeypress="return isNumericKey(event)"  readonly="true" class="form-control total'+inc+' total" id="total'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].productGroup" readonly="true" class="form-control  productGroup productGroup'+inc+'" id="productGroup'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].hsn" readonly="true" class="form-control hsnVal hsn'+inc+'" id="hsn'+inc+'"   />'
			+ '</div>'
			+'</td>'
	...
	+'</tr>';
		...
		// alert("sERVICEAppend");
		  var service_table_data='<tr class="multTot multTot'+inc+'">'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].sacCode" autocomplete="off" required="true"  class="form-control sacCode  sacCode'+inc+'" id="hsn'+inc+'"   />'
			+ '</div>'
			+'</td>'
			
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].description" readonly="true" class="form-control description '+inc+'" id="uom'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].requiredQuantity" autocomplete="off" required="true" onkeypress="return isNumericKey(event)"  class="form-control validatePrice requiredQuantity'+inc+' requiredQuantity" id="requiredQuantity'+inc+'"   />'
			+ '</div>'
			+'</td>'
			...
			+'<td>'
			+'<div class="form-group">'
			+'<input type="text" name="creditMemoLineItems['+inc+'].unitPrice" autocomplete="off"  onkeypress="return isNumericKey(event)"  required="true" class="form-control validatePrice unitPrice  unitPrice'+inc+'" id="unitPrice'+inc+'"   />'
			+ '</div>'
			+'</td>'
...
$("#items_radio").click(function() {
	//alert("item");
	 alertify.confirm("CreditMemo",'Are you Sure Want to Change  Item ,Service will be removed ', function(){
		 $("#serviceTbl").hide();
		 $("#itemTbl").show();
...
$("#service_radio").click(function() {
	//alert("service");
	 alertify.confirm("CreditMemo",'Are you Sure Want to Change Service ,Items will be removed! ', function(){
	$("#serviceTbl").show();
	 $("#itemTbl").hide();
	 $("#edit_item_serviceTbl").hide();
...
//$('form.commentForm').on('submit', function(event) {
  $(".mySubButton").on('click', function() {
	...
	if(rowCount == 0){
		alertify.alert("CreditMemo","Please Select Atleast One Item");
		 return false;
	}else{
		return true;
	}
    ...
    if ($('#service_radio').is(":checked") == true) {
 	...
 	if(rowCount1 == 0){
 		alertify.alert("CreditMemo","Please Select Atleast One  Service");
 		 return false;
 	}else{
 		return true;
 	}
...
$(document).on("keyup", ".requiredQuantity", function() {
	...
	if(totalAmt!="") {
	 ...
	 $("#amtRounding").val(totalPayment.toFixed(2));
		 ...
		 $("#totalDiscount").val("");
		alertify.alert("CreditMemo Discount","Please Enter Valid Discount!");
		 return false;
	}
