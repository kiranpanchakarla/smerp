								...
								<div class="content-body">
									...
									<div class="card">
										<div class="card-header" style="height: 60px;">
											<div class="row">
												<div class="col-md-5">
													<h2 class="content-header-title">Inventory Goods Issue Report</h2>
												</div>
												<div class="col-md-3">
														...
														<tbody>
															 ...
															 <c:forEach items="${productList}" var="product">  
																<tr>
																	...
																	<td style="text-align: center;">${product.requiredQty}</td> 
...
function getSearchFilterList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/invGIReport/getSearchFilterPROList'/>").submit();
} 


function getSearchFilterResetList() {
	 
	$('#searchFilterForm').attr('action',"<c:url value='/invGIReport/prolist'/>").submit();
} 
...
function downloadExcelFile(){		
	...
	//alert(stringQuery);
	a.href = "<c:url value='/invGIReport/exportPROExcel?id=vw_inventory_goods_issue_report?'/>"+stringQuery;
} 
</script>
