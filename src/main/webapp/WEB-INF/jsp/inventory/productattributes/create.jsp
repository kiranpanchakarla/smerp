				...
				<div class="row">
					<div class="large-12 columns">
						...
						<div class="content-body">
							...
							<c:url value="/productattributes/save" var="createUrl" />
							<form:form  method="POST" action="${createUrl}" 
								modelAttribute="productattributes" onsubmit="return register()"
										...
										<div class="col-md-12">
											<div class="card">
												<div class="card-header">
													<c:if test="${productattributes.id==null}">
														<h2 class="card-title" id="basic-layout-icons">Create New Product Attributes</h2>
													</c:if>

													<c:if test="${productattributes.id!=null}">
														<h2 class="card-title" id="basic-layout-icons">Update Product Attributes Details</h2>
													</c:if>
												</div>
													...
													<div class="card-block">
															<div class="form-body">
																...
																<div class="col-sm-4 form-group">
																	<label for="timesheetinput1">Attributes</label>
																	<div>
															...
															<div class="text-xs-center">
																...
																<c:if test="${productattributes.attributeName!=null}">
