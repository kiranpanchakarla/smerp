								...
								<div class="content-body">
									...
									<div class="card">
										<div class="card-header" style="height: 60px;">
											<div class="row">
												<div class="col-md-4">
													<h2 class="content-header-title">Inventory Goods Receipt</h2>
												</div>
												<div class="col-md-4">
														...
														<c:if test="${ump.key eq 'Inventory Goods Receipt'}">
															...
															<c:if
																...
																<a class="btn btn-primary"
																	href="<c:url value="/invgr/create"/>">Create</a>
															</c:if>
														</c:if>
													</c:forEach>
												...
												<div class="col-md-4">
													<ol class="breadcrumb">
														...
														<li class="breadcrumb-item active">Inventory Goods Receipt</li>
													</ol>
												</div>
											</div>
																			...
																			<c:if test="${ump.key eq 'Inventory Goods Receipt'}">
																				...
																				<c:if
																					...
																					<a class="btn btn-view"
																						href="<c:url value="/invgr/view?id=${list.id}"/>" data-toggle="tooltip" data-placement="top" title="View"><i
