															 ...
															 <c:forEach items="${vendorList}" var="vendor">  
																<tr>
																	...
																	<td>${vendor.warehouseName}</td> 
																	 <%--  <c:set var = "month" scope = "session" value = "${searchListMonths}"/> --%>
																	  <c:forEach items="${searchListMonths}" var="month">   
...
function getSearchFilterList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/warehouseReport/getSearchFilterPOList'/>").submit();
...
function getSearchFilterResetList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/warehouseReport/polist'/>").submit();
} 
...
function downloadExcelFile(){	
	...
	a.href = "<c:url value='/warehouseReport/exportPOExcel?id=vw_plant_wise_po_report?'/>"+stringQuery;
	 </c:if>
} 
</script>
