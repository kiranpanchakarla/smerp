							...
							<div>
								<div class="content-body">
									...
									<div class="col-md-2">
										...
										<div class="col-md-6">
										<a class="btn btn-primary" href="<c:url value="/uomcategory/getInfo?uomcategoryId=${uomcategoryObj.id}"/>">Edit</a>
									</div>
														...
														<div class="card-body collapse in">
															<div class="table-responsive">
																...
																<table
																	...
																	<tr>
																		<th>UOM Category Name</th>
																		<td>${uomcategoryObj.uomCategoryName}</td>
																	</tr>
