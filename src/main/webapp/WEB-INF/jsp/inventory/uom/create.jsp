				...
				<div class="row">
					<div class="large-12 columns">
						...
						<div class="content-body">
							...
							<c:url value="/uom/save" var="createUrl" />
							<form:form  method="POST" action="${createUrl}" 
								modelAttribute="uom" onsubmit="return register()"
										...
										<div class="col-md-12">
											<div class="card">
												<div class="card-header">
													<c:if test="${uom.id==null}">
														<h2 class="card-title" id="basic-layout-icons">Create New UOM</h2>
													</c:if>

													<c:if test="${uom.id!=null}">
														<h2 class="card-title" id="basic-layout-icons">Update UOM Details</h2>
													</c:if>
												</div>
													...
													<div class="card-block">
															<div class="form-body">
																...
																<div class="col-sm-4 form-group">
																	<label for="timesheetinput1">UOM</label>
																	<div>
																...
																<div class="col-sm-4 form-group">
																    ...
																    <label>Category</label>
																		<form:select id="uomCategory" path="uomCategory.id" cssClass="form-control" required="true" oninvalid="this.setCustomValidity('Please Select Category')" oninput="setCustomValidity('')">
															...
															<div class="text-xs-center">
											                        ...
											                        Back</a> <a href="<c:url value="/uom/list"/>">
