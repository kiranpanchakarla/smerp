								...
								<div class="content-body">
									...
									<div class="card">
										<div class="card-header" style="height: 60px;">
											<div class="row">
												<div class="col-md-5">
													<h2 class="content-header-title">Purchase Order - Product Wise Report</h2>
												</div>
												<div class="col-md-3">
...
function getSearchFilterList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/productReport/getSearchFilterPOList'/>").submit();
...
function getSearchFilterResetList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/productReport/polist'/>").submit();
} 

function downloadExcelFile(){	
	<c:if test="${searchListMonths != null}">
	var a = document.getElementById('exceldownload');
	var stringQuery = downloadExcelFileQuery();   /* This function from loadJs.jsp */
	//alert(stringQuery);
	
	a.href = "<c:url value='/productReport/exportPOExcel?id=vw_product_wise_po_report?'/>"+stringQuery;
	 </c:if>
} 
</script>
