...
@Entity
@Table(name = "tbl_credit_memo_lineitems")
public class CreditMemoLineItems  extends UserAuditModel {
	...
	public String toString() {
		return "CreditMemoLineItems [id=" + id + ", productId=" + productId + ", prodouctNumber=" + prodouctNumber
