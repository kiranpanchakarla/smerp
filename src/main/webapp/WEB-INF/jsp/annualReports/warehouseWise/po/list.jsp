								...
								<div class="content-body">
									...
									<div class="card">
										<div class="card-header" style="height: 60px;">
											<div class="row">
												<div class="col-md-8">
													<h2 class="content-header-title">Purchase Order - Warehouse Wise Annual Report</h2>
												</div>
...
function getSearchFilterList() {
	...
	$('#searchFilterForm').attr('action',"<c:url value='/annualWarehouseReport/getSearchFilterPOList'/>").submit();
} 


function getSearchFilterResetList() {
	 
	$('#searchFilterForm').attr('action',"<c:url value='/annualWarehouseReport/polist'/>").submit();
} 
