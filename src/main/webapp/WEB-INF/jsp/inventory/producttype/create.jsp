										...
										<div class="col-md-12">
											<div class="card">
												<div class="card-header">
													<c:if test="${producttypeObj.id==null}">
														<h2 class="card-title" id="basic-layout-icons">Create New Product Group</h2>
													</c:if>

													<c:if test="${producttypeObj.id!=null}">
														<h2 class="card-title" id="basic-layout-icons">Update Product Group Details</h2>
													</c:if>
												</div>
