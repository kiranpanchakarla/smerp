																			...
																			<c:if test="${purchaseRequest.type=='Item'}">
																				...
																				<c:forEach
																					...
																					<tbody>
																						...
																						<td><c:if
																								test="${listpurchaseRequestLists.warehouse==1}">
                                                                                                Madurawada
                                                                                            </c:if>
																							<c:if
																								test="${listpurchaseRequestLists.warehouse==2}">
                                                                                                Yelamanchili
                                                                                            </c:if>
																							<c:if
																								test="${listpurchaseRequestLists.warehouse==3}">
                                                                                                MVP Colony
                                                                                            </c:if>
																						</td>
