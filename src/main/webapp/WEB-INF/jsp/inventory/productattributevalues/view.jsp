							...
							<div>
								<div class="content-body">
									...
									<div class="col-md-2">
										...
										<div class="col-md-6">
										<a class="btn btn-primary" href="<c:url value="/productattributesvalues/getInfo?productattributesvaluesId=${productattributesvaluesObj.id}"/>">Edit</a>
									</div>
															...
															<div class="table-responsive">
																...
																<table
																	...
																	<tr>
																		...
																		<td>${productattributesvaluesObj.productAttributes.attributeName}</td>
																	</tr>

																	 <tr>
																		<th>Product Value</th>
																		<td>${productattributesvaluesObj.attributeValue}</td>
																	</tr>
