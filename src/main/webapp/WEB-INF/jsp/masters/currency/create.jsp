										...
										<div class="col-md-12">
											<div class="card">
												<div class="card-header">
													<c:if test="${currencyObj.id==null}">
														<h2 class="card-title" id="basic-layout-icons">Create New Currency</h2>
													</c:if>

													<c:if test="${currencyObj.id!=null}">
														<h2 class="card-title" id="basic-layout-icons">Update Currency Details</h2>
													</c:if>
												</div>
